...
\begin{itemize}[noitemsep]
  \item \textbf{Escala probada moderada:} hasta $N=1304$. Los benchmarks enormes del paper (TSP
        $>10^4$, BIRCH, ODM, RW grande) \emph{no} se ejecutaron; las afirmaciones de
        escalabilidad son conceptuales, no medidas localmente.
  \item \textbf{Sin comparación directa con Zebra:} no se reejecutó. Sí es válido mostrar que el
        ...
        Zebra reportados por Duran-Mateluna, Ales \& Elloumi (2023). Lo que no es válido es decir
        ``nuestro código supera localmente a Zebra'' sin ejecutar Zebra bajo un protocolo propio.
...
instancias probadas (OR-Library 15/15, \texttt{rl1304} 9/9 vs paper; catálogo local
\texttt{paperbench} 26/26 OK), con un separador verificado por tres vías independientes. No se
