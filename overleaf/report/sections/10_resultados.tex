...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item \textbf{El método es correcto en la escala local probada.} La evidencia consolidada
        ...
        vías (mano, test, implementación Python de referencia), es la base de esta confianza. Esta es evidencia de replicación
...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{Verificar el componente crítico paga.} Validar el separador a mano, con test y con
        implementación Python de referencia dio una base de confianza que permitió escalar sin temor a errores silenciosos.
\end{itemize}
