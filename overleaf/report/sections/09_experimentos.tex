...
El pipeline de interacción para preparar/correr subconjuntos está documentado en
\texttt{docs/INSTANCE\_SOURCES\_AND\_PIPELINE.md} y expuesto por \texttt{scripts/paperbench.py}.
...
transcritos del PDF). Fuente: \texttt{results/curated/comparison\_vs\_paper.csv}.
