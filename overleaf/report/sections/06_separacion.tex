...
Como $SP_i$ minimiza con coeficientes $\ge0$, los $z^k_i$ se hacen lo más chicos posibles:
\begin{equation}
...
\[
  \kt_i=\begin{cases}
    ...
    \max\{k\in[K_i]:\ \sum_{j:\,d_{ij}\le D^k_i}\bar y_j < 1\} & \text{en otro caso.}
  \end{cases}
\]
\end{definicion}
...
\begin{enumerate}[noitemsep]
  ...
  \item \textbf{Oráculo en Python} (\texttt{scripts/verify\_cuts.py} contra
...
con la salida de C (\texttt{--dump-cuts 0 1}) y del oráculo Python.}
\end{table}
