...
La formulación ejecutable del repositorio es \textbf{Benders/F4 con cortes perezosos derivada de
...
\begin{description}[leftmargin=1.5em]
  ...
  \item[Fase 2 — branch-and-Benders-cut.] Se imponen $y_j\in\{0,1\}$ y se resuelve con
        ...
        \textbf{callback de \textit{lazy constraints}} ejecuta el separador y agrega los cortes
...
común a ambas fases, independiente del warm-start. Confundir ambas cosas sería un error
conceptual: una es estructura de datos calculada una vez; la otra es reutilización de cortes de
Benders.
\end{quote}
...
callback de cortes perezosos. Esto deja el núcleo (parsing, distancias, $S$, separación, fases)
independiente del solver y permitiría, en principio, intercambiar el backend (CPLEX/SCIP) sin
tocar la lógica de Benders. El detalle de las firmas usadas está en \texttt{docs/SOLVER\_NOTES.md}.
