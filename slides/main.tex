...
\begin{itemize}
  ...
  \item \textbf{Implementado en C:} Benders/F4 perezosa derivada de F3; F1--F4 monolíticas solo teoría/oráculo pequeño.
\end{itemize}
\end{frame}
...
\textbf{Núcleo en C} (Benders/F4 lazy) + \textbf{capa de solver} (Gurobi) + \textbf{oráculo Python}.
\begin{columns}
...
\texttt{results/curated/*.csv}; validado por \texttt{scripts/validate\_results.py}.
\end{frame}
