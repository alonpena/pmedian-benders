...
La comparación correcta es, por tanto: \textbf{implementación completa del mecanismo Benders
central + replicación computacional parcial documentada}. El paper reporta que este método supera a Zebra; este
...
El pMP es \textbf{NP-hard} (Kariv \& Hakimi, 1979). El número de formas de elegir $p$ sitios entre
...
+ branch-and-cut con lazy constraints), permite —\emph{según reportan los autores}— superar al
