...
La implementación sigue el esquema de dos fases del paper:
...
La implementación es modular: un núcleo en C (sin solver) y una capa delgada de solver
(Gurobi). El núcleo se valida contra un oráculo en Python.
