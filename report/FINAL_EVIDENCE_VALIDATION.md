...
| referenced artifact | status | resolved path |
|---|---|---|
...
| `report/evidence/csv/gap_traces/pmed1_p5_phase1.csv` | PRESENT | `report/evidence/csv/gap_traces/pmed1_p5_phase1.csv` |
| `report/evidence/csv/gap_traces/pmed6_p5_phase1.csv` | PRESENT | `report/evidence/csv/gap_traces/pmed6_p5_phase1.csv` |
| `report/evidence/csv/gap_traces/rl1304_p5_phase1.csv` | PRESENT | `report/evidence/csv/gap_traces/rl1304_p5_phase1.csv` |
...
| `report/evidence/docs/GAP_TRACE_HANDOFF.md` | PRESENT | `report/evidence/docs/GAP_TRACE_HANDOFF.md` |
| `report/evidence/docs/MONOLITHIC_F1_BASELINE_HANDOFF.md` | PRESENT | `report/evidence/docs/MONOLITHIC_F1_BASELINE_HANDOFF.md` |
| `report/evidence/docs/ORLIB_PMED16_SMOKE_HANDOFF.md` | PRESENT | `report/evidence/docs/ORLIB_PMED16_SMOKE_HANDOFF.md` |
| `report/evidence/docs/OVERNIGHT_TIMEOUT_AUDIT.md` | PRESENT | `report/evidence/docs/OVERNIGHT_TIMEOUT_AUDIT.md` |
...
| `results/figures/benders_300s_nodes_by_instance.png` | PRESENT | `results/figures/benders_300s_nodes_by_instance.png` |
| `results/figures/benders_300s_runtime_by_instance.png` | PRESENT | `results/figures/benders_300s_runtime_by_instance.png` |
| `results/figures/benders_300s_runtime_vs_N.png` | PRESENT | `results/figures/benders_300s_runtime_vs_N.png` |
| `results/figures/benders_300s_status_summary.png` | PRESENT | `results/figures/benders_300s_status_summary.png` |
| `results/figures/benders_vs_monolithic_gap.png` | PRESENT | `report/figures/benders_vs_monolithic_gap.png` |
| `results/figures/benders_vs_monolithic_nodes.png` | PRESENT | `report/figures/benders_vs_monolithic_nodes.png` |
| `results/figures/benders_vs_monolithic_runtime.png` | PRESENT | `report/figures/benders_vs_monolithic_runtime.png` |
| `results/figures/bounds_vs_iteration_pmed1.png` | PRESENT | `report/figures/bounds_vs_iteration_pmed1.png` |
| `results/figures/gap_vs_iteration_pmed1.png` | PRESENT | `report/figures/gap_vs_iteration_pmed1.png` |
| `results/figures/synthetic_lazy_cuts_vs_N.png` | PRESENT | `report/figures/synthetic_lazy_cuts_vs_N.png` |
| `results/figures/synthetic_nodes_vs_N.png` | PRESENT | `report/figures/synthetic_nodes_vs_N.png` |
| `results/figures/synthetic_runtime_vs_N.png` | PRESENT | `report/figures/synthetic_runtime_vs_N.png` |
| `results/figures/synthetic_timeout_summary.png` | PRESENT | `report/figures/synthetic_timeout_summary.png` |
| `results/gap_traces/pmed1_p5_phase1.csv` | PRESENT | `report/evidence/csv/gap_traces/pmed1_p5_phase1.csv` |
| `results/monolithic_f1_300s.csv` | PRESENT | `report/evidence/csv/monolithic_f1_300s.csv` |
| `results/synthetic_stress_300s.csv` | PRESENT | `report/evidence/csv/synthetic_stress_300s.csv` |
| `solver_gurobi.c` | NOT_NEEDED | `source mentioned conceptually` |
| `src/heuristic.h` | PRESENT | `src/heuristic.h` |
| `src/phase1.c` | PRESENT | `src/phase1.c` |
| `src/phase2.c` | PRESENT | `src/phase2.c` |
| `src/separation.c` | PRESENT | `src/separation.c` |
| `report/evidence/csv/benders_300s_campaign.csv` | PRESENT | `report/evidence/csv/benders_300s_campaign.csv` |
| `report/evidence/csv/monolithic_f1_300s.csv` | PRESENT | `report/evidence/csv/monolithic_f1_300s.csv` |
| `report/evidence/csv/benders_real_instances_300s.csv` | PRESENT | `report/evidence/csv/benders_real_instances_300s.csv` |
| `report/evidence/csv/synthetic_stress_300s.csv` | PRESENT | `report/evidence/csv/synthetic_stress_300s.csv` |
...
| png | status | dimensions | bytes |
|---|---|---:|---:|
| `report/figures/benders_300s_lazy_cuts_by_instance.png` | PRESENT | 1200x650 | 6136 |
| `report/figures/benders_300s_nodes_by_instance.png` | PRESENT | 1200x650 | 5726 |
| `report/figures/benders_300s_runtime_by_instance.png` | PRESENT | 1200x650 | 5726 |
| `report/figures/benders_300s_runtime_vs_N.png` | PRESENT | 900x620 | 6920 |
| `report/figures/benders_300s_status_summary.png` | PRESENT | 800x500 | 3472 |
| `report/figures/benders_vs_monolithic_gap.png` | PRESENT | 950x560 | 3869 |
| `report/figures/benders_vs_monolithic_nodes.png` | PRESENT | 950x560 | 4688 |
...
| `report/figures/plot_d_iter_nodes_vs_p.png` | PRESENT | 692x516 | 23389 |
| `report/figures/synthetic_lazy_cuts_vs_N.png` | PRESENT | 950x560 | 6010 |
| `report/figures/synthetic_nodes_vs_N.png` | PRESENT | 950x560 | 4817 |
| `report/figures/synthetic_runtime_vs_N.png` | PRESENT | 950x560 | 5588 |
| `report/figures/synthetic_timeout_summary.png` | PRESENT | 800x480 | 2909 |
| `report/figures/toy_pmedian_explanation.png` | PRESENT | 900x620 | 5291 |

## Claim evidence rough check

| claim line prefix | evidence path status |
|---|---|
...
All major CSV/figure/doc/log references resolve either in-place or through consolidated evidence. PNG files under `report/figures/` are readable.
